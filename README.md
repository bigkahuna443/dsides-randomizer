...
6. If your starting room is a clutter switch room, pressing the switch may make subsequent rooms impossible to complete. This is a known issue that will be fixed in the next randomizer version.
